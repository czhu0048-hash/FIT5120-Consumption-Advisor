...
<template>
  ...
  <div v-if="showQuestionnaire" class="cq-quiz-wrap">
    <ClothingQuestionaireCard title="About to tap &quot;buy&quot;?"
      description="Six quick questions, no judgement, no pressure — just a pause" confirmLabel="Let's do it →"
      skipLabel="Already decided? Make it last" :skipIntro="true" @openCalculator="openCalculator" />
  </div>
  ...
  <div v-else class="cq-wrap">
    ...
    <div class="cq-leaf-deco" aria-hidden="true">
      <svg viewBox="0 0 200 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M180 10 C180 10 20 60 10 200 C0 340 120 290 140 200 C160 110 180 10 180 10Z" fill="#007a6f"
          opacity="0.85" />
...
@media (prefers-reduced-motion: no-preference) {
  ...
  .cq-wrap>* {
    animation: cq-rise 0.6s cubic-bezier(0.16, 1, 0.3, 1) both;
  }
